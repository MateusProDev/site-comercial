...
const EditAbout = () => {
  ...
  const [aboutData, setAboutData] = useState({
    description: "", // Apenas a descrição será editada
    aboutCarousel: {
      images: [] // O título do carrossel será fixo
    }
  });
    ...
    const fetchAboutData = async () => {
      try {
        ...
        if (aboutDoc.exists()) {
          ...
          setAboutData({
            description: data.description || "", // Carrega a descrição
            aboutCarousel: {
              images: data.aboutCarousel?.images || [] // Carrega as imagens do carrossel
            }
          });
        }
      } catch (error) {
